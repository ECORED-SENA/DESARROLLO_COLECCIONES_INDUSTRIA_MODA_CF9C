  ...
  menuPrincipal: {
    menu: [
      ...
      },
      {
        ...
        icono: 'far fa-file-alt',
        numero: '5',
        titulo: 'Transporte de rollos de tela',
        desarrolloContenidos: true,
      },
      {
        nombreRuta: 'tema6',
      ...
      },
      {
        ...
        icono: 'far fa-file-alt',
        numero: '7',
        titulo: 'Extendido industrial',
        desarrolloContenidos: true,
        subMenu: [
          {
            icono: 'far fa-file-alt',
            numero: '7.1',
            titulo: 'Extendido manual',
            hash: 't_7_1',
          },
          {
            icono: 'far fa-file-alt',
            numero: '7.2',
            titulo: 'Extendido automático con máquina extendedora',
            hash: 't_7_2',
          },
          {
            icono: 'far fa-file-alt',
            numero: '7.3',
            titulo: 'Sistemas de extendido',
            hash: 't_7_3',
          },
          {
            icono: 'far fa-file-alt',
            numero: '7.4',
            titulo: 'Sistemas de transporte de tendidos',
            hash: 't_7_4',
          },
          {
            icono: 'far fa-file-alt',
            numero: '7.5',
            titulo: 'Controles antes del corte',
            hash: 't_7_5',
          },
        ],
      },
      {
        ...
        subMenu: [
          ...
          },
          {
            icono: 'far fa-file-alt',
            numero: '8.4',
            titulo: 'Precauciones generales a la hora de cortar',
            hash: 't_8_4',
          },
          {
            icono: 'far fa-file-alt',
      ...
      },
      {
        ...
        icono: 'far fa-file-alt',
        numero: '10',
        titulo: 'Máquinas auxiliares en el departamento de corte',
        desarrolloContenidos: true,
      },
      {
        nombreRuta: 'tema11',
